...
| Derivation inside the protocol | Additive shares; the tweak is folded into the presignature | Yes; the tweak is folded into the signed message (`m + r·t`), so the 2-of-2 signs for derived addresses without a tweaked share |
