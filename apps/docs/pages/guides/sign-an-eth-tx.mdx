...
<Callout type="warning">
  Use Sepolia testnet ETH only. **Do not fund a SODA-derived address with
  real / mainnet funds** while v0 is the deployed committee — it's a single
  dev key, not a real MPC threshold. Throwaway amounts only.
</Callout>
...
const requesterProgram = new PublicKey(
  'GfAuUesztZ98BhUZv6ymLxvxty7matXJJ4xRh5zrvPkA', // eth_demo
).toBytes()
